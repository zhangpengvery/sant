...
Page({
  ...
  async getAddressInfo(address_id){
    ...
    this.setData({
      ...
      'addressCity[0]':result.data.data.address_info.province_name,
      'addressCity[1]':result.data.data.address_info.city_name,
      'addressCity[2]':result.data.data.address_info.area_name,
    })
