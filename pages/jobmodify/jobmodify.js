...
Page({
  ...
  //求职详情
  async geteditRecruit(jr_id){
    wx.showLoading({
      title: '加载中...',
    })
    let result=await requestApi(app.globalData.base_url+"/editRecruit",{
      jr_id:jr_id
    })
    ...
    this.setData({
      recruit_title:result.data.data.recruit_info.recruit_title,
      contact_name:result.data.data.recruit_info.contact_name,
      contact_tel:result.data.data.recruit_info.contact_tel,
      recruit_message:result.data.data.recruit_info.recruit_message,
      selectAreaId:result.data.data.recruit_info.area_id,
  ...
  async getJobBasicData(){
    ...
    bddhFn:function(){
      this.editRecruit(this.data.jr_id,this.data.recruit_title,this.data.jt_id,this.data.js_id,this.data.je_id,this.data.recruit_age,this.data.recruit_message,this.data.selectAreaId,this.data.contact_name,this.data.contact_tel)
    },
  /**
   * 生命周期函数--监听页面加载
   */
