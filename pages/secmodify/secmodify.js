...
Page({
  ...
  bddhFn:function(){
    this.postEditSale(this.data.pics,this.data.selectProvinceId,this.data.selectCityId,this.data.selectAreaId,this.data.sale_title,this.data.contact_name,this.data.contact_tel,this.data.sale_price,this.data.sale_message,this.data.sale_id,this.data.uc_id)
  },
  //获取省份列表
