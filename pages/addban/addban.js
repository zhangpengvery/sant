...
Page({
  ...
  shenaddFor(realname,mobile,area_id,content){
    requestApi1(app.globalData.post_url+"/index.php/Api/Shen/addFor",{
      realname:realname,
      mobile:mobile,
      area_id:area_id,
      content:content
  ...
  bddhFn: function () {
    if(wx.getStorageSync('token')==[]){
      ...
      this.shenaddFor(this.data.realname,this.data.mobile,this.data.selectAreaId,this.data.content)
    }
  },
  /**
   * 生命周期函数--监听页面加载
