...
Page({
  ...
  postAddSale(pics,province_id,city_id,area_id,sale_title,contact_name,contact_tel,sale_price,sale_message){
    wx.showLoading({
      title: '发布中...',
    })
    requestApi1(app.globalData.base_url+"/addSale",{
      pics:pics,
  ...
  zhenghe:function(){
    ...
    var s=url.join(',')
    this.postAddSale(s,this.data.selectProvinceId,this.data.selectCityId,this.data.selectAreaId,this.data.sale_title,this.data.contact_name,this.data.contact_tel,this.data.sale_price,this.data.sale_message)
  },
  /**
   * 生命周期函数--监听页面加载
   */
