...
Page({
  ...
  postaddApply(apply_title, job_type_id, apply_salary, apply_experince, apply_company, apply_message, area_id, contact_name, contact_tel) {
    requestApi1(app.globalData.base_url + "/addApply", {
