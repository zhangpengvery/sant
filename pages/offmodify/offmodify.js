...
Page({
  ...
  async geteditApply(ja_id) {
    let result = await requestApi(app.globalData.base_url + "/editApply", {
      ja_id: ja_id
    })
    console.log(result.data.data.apply_info);
    this.setData({
      apply_title: result.data.data.apply_info.apply_title,
      contact_name: result.data.data.apply_info.contact_name,
      contact_tel: result.data.data.apply_info.contact_tel,
      apply_message: result.data.data.apply_info.apply_message,
      selectAreaId: result.data.data.apply_info.area_id,
      ...
      jt_name:result.data.data.apply_info.job_name,
      je_name:result.data.data.apply_info.ex_name,
      js_name:result.data.data.apply_info.salary_name,
  ...
  editApply(ja_id, apply_title, job_type_id, apply_salary, apply_experince, apply_company, apply_message, area_id, contact_name, contact_tel) {
    requestApi1(app.globalData.base_url + "/editApply", {
      ja_id: ja_id,
      apply_title: apply_title,
      job_type_id: job_type_id,
      apply_salary: apply_salary,
      apply_experince: apply_experince,
  ...
  bddhFn: function () {
    this.editApply(this.data.ja_id, this.data.apply_title, this.data.jt_id, this.data.js_id, this.data.je_id, this.data.apply_company, this.data.apply_message, this.data.selectAreaId, this.data.contact_name, this.data.contact_tel)
  },
  /**
   * 生命周期函数--监听页面加载
   */
  onLoad: function (options) {
    ...
    this.geteditApply(options.ja_id)
    this.getProvince()
